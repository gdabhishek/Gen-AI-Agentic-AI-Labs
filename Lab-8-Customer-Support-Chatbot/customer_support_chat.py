...
def create_rag_chain(vector_store: Qdrant = None):
    ...
    if not config.LLM_BASE_URL:
        ...
        llm = init_chat_model(config.LLM_MODEL, model_provider=config.LLM_PROVIDER, base_url=config.LLM_BASE_URL)
...
def get_chatbot_with_memory(vector_store: Qdrant = None):
    """
    Get chatbot instance with RAG and persistent memory
    ...
    Returns:
        RunnableWithMessageHistory instance ready for chat
    """
    # Create RAG chain
